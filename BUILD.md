...
2. 「Avalonia」で検索 → **Avalonia for Visual Studio 2022** をインストール
3. VS 再起動
...
2. 🪟 `build-macapp.sh` の `VERSION` を上げる(VS 2022 から直接編集可)
3. 🪟 git commit & push
4. 🍎 Mac で `git pull && ./build-macapp.sh`
5. 🌐 Jamf Pro に新 PKG をアップロード、ポリシーで配信
